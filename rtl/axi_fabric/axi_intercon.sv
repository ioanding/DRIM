...
module axi_intercon
   (input  logic        clk_i,
    ...
    input  logic  [0:0] i_icache_awuser,
    ...
    input  logic  [0:0] i_icache_aruser,
    ...
    input  logic  [0:0] i_icache_wuser,
    ...
    output logic  [0:0] o_icache_buser,
    ...
    output logic  [0:0] o_icache_ruser,
    ...
    input  logic  [0:0] i_dcache_awuser,
    ...
    input  logic  [0:0] i_dcache_aruser,
    ...
    input  logic  [0:0] i_dcache_wuser,
    ...
    output logic  [0:0] o_dcache_buser,
    ...
    output logic  [0:0] o_dcache_ruser,
    ...
    output logic  [0:0] o_mem_one_awuser,
    ...
    output logic  [0:0] o_mem_one_aruser,
    ...
    output logic  [0:0] o_mem_one_wuser,
    ...
    input  logic  [0:0] i_mem_one_buser,
    ...
    input  logic  [0:0] i_mem_one_ruser,
